...
public class test1 {
	...
	public static void main(String[] args) throws InterruptedException {		
		...
		//driver.findElement(By.cssSelector("[type='email']")).sendKeys("mosbah.alnawashi@gmail.com");
		//driver.findElement(By.cssSelector("[type='email']")).sendKeys(Keys.ENTER);
		//Thread.sleep(3000);
		//driver.findElement(By.cssSelector("[type='password']")).sendKeys("P@$$w0rd2020");
		//driver.findElement(By.cssSelector("[type='password']")).sendKeys(Keys.ENTER);
		//Thread.sleep(5000);
		//String url = driver.getCurrentUrl();
		
		String url = "		String url = \"https://rahulshettyacademy.com/getCourse.php?state=verifyfjdss&code=4%2F0QF-ki0874DMBDvriaUEVT4NbWlkZgB9dNsDcf1tOaeo9gtNnh3NBbIoGOTy_VxYb05vapeTwawweMmlVJeA2B8&scope=email+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email+openid&authuser=0&prompt=consent#\";\r\n";
